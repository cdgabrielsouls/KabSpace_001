...
import { createReservation, loadReservations, type Reservation, watchProfessorReservations, watchReservations } from '../data/reservationRepository'
...
export default function CeitBuilding() {
  ...
  function roomReservation(roomId: string) {
    return reservations.find((reservation) => reservation.roomId === roomId && reservation.floorNumber === floor.number)
  }
